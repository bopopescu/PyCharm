    ...
    def valida_saida(self, pessoa: str):
        ...
        if pessoa in self.__pessoas:
            ...
            if len(self.__pessoas) <= 4:
                ...
                if pessoa == 'chefe de serviço' and 'piloto' in self.__pessoas and 'comissário1' in \
                        self.__pessoas and 'comissário2' in self.__pessoas:
                    return False
                    # piloto - comissários
                if pessoa == 'piloto' and 'chefe de serviço' in self.__pessoas and 'oficial1' \
